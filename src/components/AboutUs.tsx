...
export default function AboutUs({ testimonials = [], teamMembers = [], customization }: AboutUsProps) {
  ...
  const milestones = [
    ...
    { date: "2025", title: "KonsOS MCDA Formulation", desc: "Released research paper and compliance modeling tool for aerospace audit pipelines." },
    { date: "2026", title: "Active AI Middleware Launch", desc: "Released KonsAi connecting server-side SQL targets securely to LLM agents." }
  ];
